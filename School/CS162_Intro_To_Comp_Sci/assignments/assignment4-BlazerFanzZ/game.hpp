...
private:
	...
	vector <vector<Room> > gameboard_vec;
...
public:
	 ...
	 * Author: Dylan Peniuk
	 * Date: 11/26/24
	 * Function: hunt_wumpus
	 * Description: sets the location of the wumpus on the board
	 * Parameters:
	 * 		None
	 * Post-condition: wumpus is placed on board where room event is null
	 */
